...
public enum BuildingStructure {
    ...
    BuildingStructure(String name,int wood, int stone, int gold, int hp , int laddernans) {
        this.name = name;
        this.wood = wood;
        this.stone = stone;
        this.gold = gold;
    ...
    public static BuildingStructure getBuildingStructureByName(String name) {
        for(BuildingStructure value : BuildingStructure.values())
